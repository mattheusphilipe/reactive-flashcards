    ...
    public static class MailMessageDTOBuilder {
       private String destination;
        ...
        public MailMessageDTOBuilder questions(final List<Question> questions) {
            ...
            questions.sort(Comparator.comparing(Question::answeredIn)); // garantir que está sendo pego na ordem que foi respondida
            return variables("questions", questions);
        }

        public MailMessageDTO build() {
            return new MailMessageDTO( destination, subject, "email/studyResult", variables);
        }
    }
}
