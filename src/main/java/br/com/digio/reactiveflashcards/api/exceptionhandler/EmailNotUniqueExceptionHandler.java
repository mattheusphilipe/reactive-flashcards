...
@Slf4j
public class EmailNotUniqueExceptionHandler extends AbstractHandlerException<EmailNotUniqueException> {

    public EmailNotUniqueExceptionHandler(final ObjectMapper mapper) { super(mapper); }

    @Override
    public Mono<Void> handlerException(ServerWebExchange exchange, EmailNotUniqueException ex) {
        return Mono
                .fromCallable(() -> {
